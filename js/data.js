...
(function () {
  ...
  const FISH = [
    ...
    { id: "bullfrogfish",name: "Bullfrog Fish",area: "swamp", rarity: "uncommon", size: 2, value: 200, minDepth: 0,  color: "#6a8a3a", accent: "#caa15a", shape: "frog" },
    ...
    { id: "prismlux", name: "Jeweled Fish", area: "prism", luxury: true, legendary: true, rarity: "mythic", size: 4, value: 96000, minDepth: 0, color: "#ffd24a", accent: "#fff3b0", trim: "#5bf0ff", shape: "ray" },
    { id: "swamplux", name: "Royal Fish", area: "swamp", luxury: true, legendary: true, rarity: "mythic", size: 4, value: 130000, minDepth: 0, color: "#ffd24a", accent: "#fff3b0", trim: "#5bf0ff", shape: "ray" },
