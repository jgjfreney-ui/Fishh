...
(function () {
  ...
  const FISH = [
    ...
    { id: "bullfrogfish",name: "Bullfrog",     area: "swamp", rarity: "uncommon", size: 2, value: 200, minDepth: 0,  color: "#6a8a3a", accent: "#caa15a", shape: "frog" },
    { id: "gianttadpole", name: "Giant Tadpole", area: "swamp", legendary: true, rarity: "mythic", size: 4, value: 7000, minDepth: 0, color: "#3a5a2a", accent: "#bfe0a0", trim: "#5bf0ff", shape: "tadpole" },
    ...
    { id: "chairsnail", name: "Chair Snail",   area: "backrooms", creature: true, furniture: true, rarity: "common", size: 1, value: 220, color: "#9a7a4a", accent: "#caa15a", shape: "chairsnail" },
    { id: "tableturtle", name: "Table Turtle", area: "backrooms", rarity: "common", size: 2, value: 260, minDepth: 0, color: "#8a6a3a", accent: "#caa15a", shape: "tableturtle" },
    { id: "lampsquid", name: "Lamp Squid",     area: "backrooms", rarity: "common", size: 1, value: 240, minDepth: 0, color: "#c8b84a", accent: "#fff3b0", shape: "lampsquid", glow: true },
    { id: "captaincarp", name: "Captain Carp", area: "backrooms", secretBoss: true, aggressive: true, rarity: "mythic", size: 14, value: 50000, minDepth: 0, color: "#5a6a3a", accent: "#caa15a", trim: "#1a1a1a", shape: "captaincarp", hp: 8, reward: "nullzone",
      hint: "Catch a Chair Snail, Table Turtle AND Lamp Squid ten times each, and a furious hat-wearing carp will surface to take revenge." },
    ...
    { id: "corallux", name: "Golden Coast", area: "coral", luxury: true, legendary: true, rarity: "mythic", size: 4, value: 60000, minDepth: 0, color: "#ffd24a", accent: "#fff3b0", trim: "#5bf0ff", shape: "ray" },
    { id: "riverlux", name: "Jeweled Fish", area: "river", luxury: true, legendary: true, rarity: "mythic", size: 4, value: 68500, minDepth: 0, color: "#ffd24a", accent: "#fff3b0", trim: "#5bf0ff", shape: "ray" },
    { id: "forestlux", name: "Royal Fish", area: "forest", luxury: true, legendary: true, rarity: "mythic", size: 4, value: 77000, minDepth: 0, color: "#ffd24a", accent: "#fff3b0", trim: "#5bf0ff", shape: "tang" },
    ...
    { id: "prismlux", name: "Giant Coral Hermit Crab", area: "prism", luxury: true, legendary: true, rarity: "mythic", size: 6, value: 120000, minDepth: 0, color: "#ff5b9f", accent: "#ffcf3a", trim: "#5bf0ff", shape: "hermitcrab" },
    { id: "swamplux", name: "Colossal Frog", area: "swamp", luxury: true, legendary: true, rarity: "mythic", size: 7, value: 130000, minDepth: 0, color: "#3a7a2a", accent: "#bfe0a0", trim: "#ffd24a", shape: "bigfrog" },
    { id: "boneyardlux", name: "Diamond Fish", area: "boneyard", luxury: true, legendary: true, rarity: "mythic", size: 4, value: 164666, minDepth: 0, color: "#ffd24a", accent: "#fff3b0", trim: "#5bf0ff", shape: "tang" },
    { id: "stormlux", name: "Crystal Fish", area: "storm", luxury: true, legendary: true, rarity: "mythic", size: 4, value: 186000, minDepth: 0, color: "#ffd24a", accent: "#fff3b0", trim: "#5bf0ff", shape: "tang" },
    { id: "mountainlux", name: "Platinum Fish", area: "mountain", luxury: true, legendary: true, rarity: "mythic", size: 4, value: 170666, minDepth: 0, color: "#ffd24a", accent: "#fff3b0", trim: "#5bf0ff", shape: "ray" },
    { id: "olympuslux", name: "Opal Fish", area: "olympus", luxury: true, legendary: true, rarity: "mythic", size: 4, value: 92000, minDepth: 0, color: "#ffd24a", accent: "#fff3b0", trim: "#5bf0ff", shape: "ray" },
    { id: "junglelux", name: "Sapphire Fish", area: "jungle", luxury: true, legendary: true, rarity: "mythic", size: 4, value: 60000, minDepth: 0, color: "#ffd24a", accent: "#fff3b0", trim: "#5bf0ff", shape: "sword" },
    { id: "grottolux", name: "Golden Fish", area: "grotto", luxury: true, legendary: true, rarity: "mythic", size: 4, value: 68000, minDepth: 0, color: "#ffd24a", accent: "#fff3b0", trim: "#5bf0ff", shape: "sword" },
    { id: "ashenlux", name: "Jeweled Fish", area: "ashen", luxury: true, legendary: true, rarity: "mythic", size: 4, value: 142666, minDepth: 0, color: "#ffd24a", accent: "#fff3b0", trim: "#5bf0ff", shape: "tang" },
    { id: "piratelux", name: "Royal Fish", area: "pirate", luxury: true, legendary: true, rarity: "mythic", size: 4, value: 84000, minDepth: 0, color: "#ffd24a", accent: "#fff3b0", trim: "#5bf0ff", shape: "ray" },
    { id: "backroomslux", name: "Diamond Backrooms", area: "backrooms", luxury: true, legendary: true, rarity: "mythic", size: 4, value: 92000, minDepth: 0, color: "#ffd24a", accent: "#fff3b0", trim: "#5bf0ff", shape: "ray" },
    { id: "japanlux", name: "Crystal Fish", area: "japan", luxury: true, legendary: true, rarity: "mythic", size: 4, value: 60000, minDepth: 0, color: "#ffd24a", accent: "#fff3b0", trim: "#5bf0ff", shape: "ray" },
    { id: "oilriglux", name: "Platinum Fish", area: "oilrig", luxury: true, legendary: true, rarity: "mythic", size: 4, value: 68000, minDepth: 0, color: "#ffd24a", accent: "#fff3b0", trim: "#5bf0ff", shape: "tang" },
    ...
    // Gloom Cavern resident fish — pale, drab cave-dwellers lit only by their own glow
    { id: "blindcavefish", name: "Blind Cave Fish", area: "cave", rarity: "common",   size: 1, value: 220, minDepth: 0,   color: "#d8d0c8", accent: "#b0a8a0", shape: "fish" },
    { id: "gloomgoby",  name: "Gloom Goby",    area: "cave", rarity: "common",   size: 1, value: 240, minDepth: 0,   color: "#5a5a62", accent: "#7a7a82", shape: "goby" },
    { id: "cavehatchet", name: "Ghost Hatchetfish", area: "cave", rarity: "uncommon", size: 1, value: 340, minDepth: 40, color: "#9aa0a8", accent: "#cfd6de", shape: "hatchetfish", glow: true },
    { id: "palevipereel", name: "Pale Viper Eel", area: "cave", rarity: "uncommon", size: 3, value: 460, minDepth: 80, color: "#6a6258", accent: "#9fffd0", shape: "eel", glow: true },
    { id: "cavefangtooth", name: "Cave Fangtooth", area: "cave", rarity: "rare",    size: 2, value: 700, minDepth: 150, color: "#3a3640", accent: "#7a8a90", shape: "fangtooth", glow: true },
    { id: "lanternlure", name: "Lantern Lurefish", area: "cave", rarity: "rare",    size: 2, value: 760, minDepth: 200, color: "#2a2a30", accent: "#ffe98a", shape: "lantern", glow: true },
    { id: "cavebarreleye", name: "Cave Barreleye", area: "cave", rarity: "uncommon", size: 2, value: 420, minDepth: 120, color: "#4a4e58", accent: "#9fd0ff", shape: "barreleye", glow: true },
    { id: "drabdragonfish", name: "Drab Dragonfish", area: "cave", rarity: "epic",   size: 3, value: 1800, minDepth: 280, color: "#2a2e2a", accent: "#9affd0", shape: "dragonfish", glow: true },
